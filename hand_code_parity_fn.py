...
def hand_code_optimal_parity_fn(n,weightscale):
    ...
    for s in range(logn):
        ...
        layer1 = layer1 + A.astype(np.float32)
        W.append(layer1)
        ...
        bias1 = bias1 + A.astype(np.float32)
        b.append(bias1)
