...
fo.write("#SBATCH --output=/n/home09/mnye/parity_fn/results/expt%d/logs/%s.out\n" % (settings.expt, jobname))
fo.write("#SBATCH --error=/n/home09/mnye/parity_fn/results/expt%d/logs/%s.err\n" % (settings.expt,jobname))
...
if settings.mail:
    ...
    fo.write('#SBATCH --mail-user=mnye@college.harvard.edu\n')
fo.write("\ncd %s\n" %  os.getcwd())
